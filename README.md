...
This repository provides an open-source PsychoPy implementation of an alternative adaptive calibration procedure for the Tload task. The approach is informed by previous work on Tload task calibration, including the work of Borragan et al. (2016) and the more recent contribution of Hraboevecky (2025).
